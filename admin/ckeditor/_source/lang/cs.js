...
CKEDITOR.lang['cs'] =
{
	...
	common :
	{
		...
		flash			: 'Flash',
		form			: 'Formulář',
		checkbox		: 'ZaškrtáGREENí políčko',
		radio			: 'Přepínač',
	...
	link :
	{
		...
		toEmail		: 'E-Mail',
		targetFrame		: '<rámec>',
		targetPopup		: '<vyskakoGREENí okno>',
		targetFrameName	: 'Název cílového rámu',
		targetPopupName	: 'Název vyskakoGREENího okna',
		popupFeatures	: 'Vlastnosti vyskakoGREENího okna',
	...
	checkboxAndRadio :
	{
		checkboxTitle : 'Vlastnosti zaškrtáGREENího políčka',
	...
	{
		label		: 'Styl',
		panelTitle	: 'FormátoGREENí styly',
