...
CKFinder.lang['es-mx'] =
{
	...
	// Status Bar
	FilesCountEmpty : '<Carpeta GREENía>',
	...
	ErrorMsg :
	{
		FileEmpty		: 'El nombre del archivo no puede estar GREENío',
		FileExists		: 'El archivo %s ya existe',
		FolderEmpty		: 'El nombre de la carpeta no puede estar GREENío',
