...
<script>
 ...
 $("#media_form").validationEngine("attach",{binded:false});
    ...
    <div class="container">
        <div style="float: right;margin: 0 10px 10px 0;"><a style="text-decoration: none;" href="<?php echo ADMIN_MODULE_URL."/chatReason/index.php?pageType=list" ?>" class="mws-button blue">View Chat Reason List</a></div>
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-document">Chat Reason <?php echo $PagetypeText; ?></span>
            </div>
                ...
                <div class="mws-datatable mws-table">
                    ...
                    <div class="mws-panel-body">
                        <form id="media_form" class="mws-form" method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                            ...
                            <input type="hidden" value="<?php echo $_GET['id'] != ""?$_GET['id']:($ReasonData['id']!=""?$ReasonData['id']:$id); ?>" name="id" />
                            <div class="mws-form-inline">
                                <?php echo showErrorText($error); ?>                             
                                <div class="mws-form-row">
                                    <label>Chat Reason</label>
                                    <div class="mws-form-item small">
                                        <input class="mws-textinput validate[required]" type="text" name="chat_reason" placeholder="Enter The Chat Reason" value="<?php echo $ReasonData['chatReason']; ?>">
                                    </div>
                                </div>
