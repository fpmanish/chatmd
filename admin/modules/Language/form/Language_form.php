...
<script>
 ...
 $("#media_form").validationEngine("attach",{binded:false});
    ...
    <div class="container">
        <div style="float: right;margin: 0 10px 10px 0;"><a style="text-decoration: none;" href="<?php echo ADMIN_MODULE_URL."/Language/index.php?pageType=list" ?>" class="mws-button blue">View Language List</a></div>
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-document">Language <?php echo $PagetypeText; ?></span>
            </div>
                ...
                <div class="mws-datatable mws-table">
                    ...
                    <div class="mws-panel-body">
                        <form id="media_form" class="mws-form" method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                            ...
                            <input type="hidden" value="<?php echo $_GET['Language_id'] != ""?$_GET['Language_id']:($LanguageData['language_id']!=""?$LanguageData['language_id']:$Language_id); ?>" name="Language_id" />
                            <div class="mws-form-inline">
                                <?php echo showErrorText($error); ?>                             
                                <div class="mws-form-row">
                                    <label>Language Name</label>
                                    <div class="mws-form-item small">
                                        <input class="mws-textinput validate[required]" type="text" name="Language_name" placeholder="Enter The Language" value="<?php echo $LanguageData['name']; ?>">
                                    </div>
                                </div>
