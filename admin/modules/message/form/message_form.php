...
<script>
    ...
    <div class="container">
        <div style="float: right;margin: 0 10px 10px 0;"><a style="text-decoration: none;" href="<?php echo ADMIN_MODULE_URL."/message/index.php?pageType=list" ?>" class="mws-button blue">View Message List</a></div>
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span class="mws-i-24 i-new-releases">Message <?php echo $PagetypeText; ?></span>
            </div>
                ...
                <div class="mws-datatable mws-table">
                    ...
                    <div class="mws-panel-body">
                        <form id="media_form" class="mws-form" method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                            ...
                            <input type="hidden" value="<?php echo $_GET['id'] != ""?$_GET['id']:($messageData['id']!=""?$messageData['id']:$id); ?>" name="edit_id" />
                            <div class="mws-form-inline">
                                <?php echo showErrorText($error); ?>                             
                                <div class="mws-form-row">
                                    <label>Message Title</label>
                                    <div class="mws-form-item small">
                                        <input class="mws-textinput validate[required]" type="text" name="title" placeholder="Enter The Page Name" value="<?php echo $messageData['message_title']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item small">
<textarea id="page_content" class="validate[required]" name="message"><?php echo $messageData['message_content']; ?></textarea>
</div>
                                </div>
