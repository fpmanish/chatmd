...
<script>
 ...
 $("#media_form").validationEngine("attach",{binded:false});
    ...
    <div class="container">
        <div style="float: right;margin: 0 10px 10px 0;"><a style="text-decoration: none;" href="<?php echo ADMIN_MODULE_URL."/blogCategory/index.php?pageType=list" ?>" class="mws-button blue">View Category List</a></div>
                ...
                <div class="mws-datatable mws-table">
                    ...
                    <div class="mws-panel-body">
                        <form id="media_form" class="mws-form" method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                            ...
                            <input type="hidden" value="<?php echo $_GET['id'] != ""?$_GET['id']:($blogCategoryData['id']!=""?$blogCategoryData['id']:$id); ?>" name="id" />
                            <div class="mws-form-inline">
                                <?php echo showErrorText($error); ?>                             
                                <div class="mws-form-row">
                                    <label>Category Name</label>
                                    <div class="mws-form-item small">
                                        <input class="mws-textinput validate[required]" type="text" name="category_name" placeholder="Enter The Category" value="<?php echo $blogCategoryData['blog_categoryName']; ?>">
                                    </div>
                                </div>
