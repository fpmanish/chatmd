...
<script>
  ...
  <input type="checkbox" name="edit_password" id="edit_password" value="1" /><label for="edit_password" id="change_password" style="float:inherit">&nbsp;&nbsp;Change Password?</label>                                    <label>Password</label>
                        ...
                        <option value="10" <?php if ($doctorData['Experience']==10) { echo "selected='selected'";}?>><?php echo (date("Y")-10)?> (10+ years)</option>
                    			...
                    			<div class="mws-form-row">
                    				<label>Doctor Ratting  </label>
                    				<div class="mws-form-item small">
                    					<select class="chzn-select validate[required]" name="ratting">
                    						<option value=""> Not Specified </option>
                  		<option value="0" <?php if ($doctorData['Ratting']==0) { echo "selected='selected'";}?> > (2 star)</option>
                        <option value="1" <?php if ($doctorData['Ratting']==1) { echo "selected='selected'";}?>> (2+ star)</option>
                        <option value="2" <?php if ($doctorData['Ratting']==2) { echo "selected='selected'";}?>> (3 star)</option>
                        <option value="3" <?php if ($doctorData['Ratting']==3) { echo "selected='selected'";}?>> (3+ star)</option>
                        <option value="4" <?php if ($doctorData['Ratting']==4) { echo "selected='selected'";}?>> (4 star)</option>
                        <option value="5" <?php if ($doctorData['Ratting']==5) { echo "selected='selected'";}?>>(4+ star)</option>
                        <option value="6" <?php if ($doctorData['Ratting']==6) { echo "selected='selected'";}?>>(5 star)</option>
                  			...
                  			<?php }?>
                    			...
                    			<?php }?>
                    			  <!-- <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item small">
                                        <input class="mws-textinput " name="paypal_id" type="text"   value="<?php {echo $patientData['paypal_id'];}  ?>">
                                    </div>
                                </div> -->
                                 <div class="mws-form-row">
