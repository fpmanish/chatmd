    ...
    if ($('a.lightboxTrigger').length){ //checks to see if there is a lightbox trigger on the page
      ...
      <div class="PaddATL50">
        <div>
          <div>
          <div>
            <div class="font22" style="float:left">News Releases</div>
            <div class="font22" style="float:left; padding-left:50px;">Archive</div>
            </div>
          ...
          <div>
            ...
            <div>
              <div class="pdTB20" id="player_section_<?php echo $i; ?>">
                <div class="fl width220 MarL10"><img src="<?php echo Uploads_URL."/image.php?src=".$cmsObj->getNewsImageById($NewsList[$i]['news_id'])."&h=148&w=220&q=100"; ?>" /></div>
                <div class="fl width600" style="width:913px;text-align:justify;">
                  <div><strong><?php  echo $NewsList[$i]['news_headlines']; ?></strong><br>
                    <br>
                   ...
                   <div>
				   <?php  
				   $string=$NewsList[$i]['news_content'];
