   ...
   <p> <?php echo  $mediaObj->getVideoCodeById($productPages[$i]['video_id'],315,560); ?> </p>
                ...
                <div class="fl width600">
                  <div><?php echo $productPages[$i]['video_name']; ?><br>
                    Album: <strong><?php echo htmlspecialchars_decode($productPages['album_name']); ?></strong><br>
                    <br>
                  </div>
                   <div><?php $vedioDetails=$mediaObj->getVideoById($productPages[$i]['video_id']); echo htmlspecialchars_decode( $vedioDetails['vedio_description']); ?>
                   </div> 
                </div>
                <div class="cls"></div>
              </div>
