      ...
      <div class="PaddATL50">
        <div>
          ...
          <div>
              ...
              ?>
            <div id="new_<?php echo  $Newsnullarch[$i]['news_id'] ?>">
              <div class="pdTB20" id="player_section_<?php echo $i; ?>">
                ...
                <div class="fl width600" style="width:913px;text-align:justify;">
                  <div><strong><?php  echo $Newsnullarch[$i]['news_headlines']; ?></strong><br>
                   ...
                   <div>
				   <?php  
				   $string=htmlspecialchars_decode($Newsnullarch[$i]['news_content']);
...
<a class="lightboxTrigger" href="#lightboxContent_<?php echo $i; ?>"><div style=" margin-left:859px;"><img src="<?php echo IMAGE_URL; ?>/read-more-button.png"; ></div></a>
