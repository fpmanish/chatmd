...
public function __construct($config=""){
  ...
  //default settings
  $settings = array(
  'business' => 'satyanarayan@futureprofilez.com',         //paypal email address
  'currency' => 'USD',                       //paypal currency
  'cursymbol'=> '$',                   //currency symbol
  'location' => 'GB',                        //location code  (ex GB)
  'returnurl'=> 'https://chat-md.com/modules/sign_up/doctorRegistration.php',//where to go back when the transaction is done.
  ...
  'notifyurl'=> 'https://chat-md.com/modules/sign_up/doctorRegistration.php',//Where to go if the user cancels.
  ...
  $this->items = array();
    ...
    public function getCheckoutForm(){
       ...
       <input type="hidden" name="notify" value="'.$this->notifyurl.'" />			
       ...
       <input type="hidden" name="doc_email" value="'.$this->email.'" />
       ';
