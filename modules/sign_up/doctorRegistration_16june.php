  ...
  <div class="row">
    ...
    <div class="inner-main-bg">
      <div class="inner_heading_bg">Doctor Registration</div>
      	<form action="<?php echo $_SERVER['PHP_SELF'];?>"  id="Doc_reg" method="post">
	...
	<label for="squaredThree"></label></div></div><div class="check-text">I have read and accept Chat MD <a href="#" id="TermUse">Terms of Use</a>.</div>
            ...
            <!-- <div class="name">Choose Payment :</div>
            <div class="radio_text">
          	<div class="fl"><input type="radio" checked="" class="regular-radio" name="payment" id="payment1" value="0"><label for="payment1"></label></div><div class="fl mr-right">Credit Card Payment</div>
			<div class="fl"><input type="radio" class="regular-radio" name="payment" id="payment2"><label for="payment2"value="1"></label></div><div>Paypal Payment</div>
            </div> -->
