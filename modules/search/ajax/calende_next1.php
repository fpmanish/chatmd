...
?>
   	<div class="calender" id="docTable1_<?php echo $id;?>">
        	<div class="cl-row">
	<div class="cl-row-head <?php echo $id;?>" ><a href="javascript:">
        			<img src="<?php echo IMAGE_URL;?>/table_arrow_left.png" alt="arrow" id="doctorPre_<?php echo $id;?>" onClick="PriviousCalenderApp(this)" >
        			</a></div>            	
...
<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+1 day")),date("h:i a",$k));
			...
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$k."&date=".strtotime($date1 ."+1 day"); ?>">
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            	...
            	<div class="cl-time">
            		<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+1 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
            					<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$n."&date=".strtotime($date1 ."+1 day"); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
	<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+2 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$k."&date=".strtotime($date1 ."+2 day"); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
	<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+2 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>		
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$n."&date=".strtotime($date1 ."+2 day"); ?>">
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
    ...
    <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
		<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+3 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$k."&date=".strtotime($date1 ."+3 day"); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
		<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+3 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>	
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$n."&date=".strtotime($date1 ."+3 day"); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
		<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+4 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>	
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$k."&date=".strtotime($date1 ."+4 day"); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
	<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+4 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>				
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$n."&date=".strtotime($date1 ."+4 day"); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
   	...
   	<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+5 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>		
   			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$k."&date=".strtotime($date1 ."+5 day"); ?>">
...
<?php echo date("h:i a",$k); ?> </a><?php }?></div>
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
   ...
   <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
 		  	<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+5 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>	
 			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$n."&date=".strtotime($date1 ."+5 day"); ?>">
...
<?php echo date("h:i a",$k); ?> </a><?php }?></div>
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>	
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$k."&date=".strtotime($date1 ."+6 day"); ?>">
...
<?php echo date("h:i a",$k); ?> </a><?php }?></div>
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+6 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>		
					<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$n."&date=".strtotime($date1 ."+6 day"); ?>">
...
<?php if ($l>5 && $returndate !="") {?>
     ...
     <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>	
 			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$k."&date=".strtotime($date1 ."+7 day"); ?>">
...
<?php echo date("h:i a",$k); ?> </a><?php }?></div>
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
 		<?php $availabilty=$appointmentObj->checkAvilableTime($id,date('d-m-Y',strtotime($date1 ."+7 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>	
 			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$n."&date=".strtotime($date1 ."+7 day"); ?>">
...
<?php echo date("h:i a",$k); ?> </a><?php }?></div>
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
        		<div class="cl-row-head <?php echo $id;?>"><a href="javascript:"><img src="<?php echo IMAGE_URL;?>/table_arrow_right.png" alt="arrow" id="doctorNext_<?php echo $id;?>" onClick="NextCalenderapp(this)"></a></div>
