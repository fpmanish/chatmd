...
$findObj = new find();
	 ...
	 $test1=$_GET['my_id'];
	 $AppointmentArr=  $appointmentObj->appointmentListbydoctorId($test1,2);
	 //echo "<pre>";print_r($AppointmentArr);
	 
?>

<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="slideTab()">×</button>
...
<div id="uploadOffice_<?php echo $test1;?>">
	<div class="calender" id="docTable2_<?php echo $test1;?>">
        	<div class="cl-row">
	<div class="cl-row-head <?php echo $test1;?>" ><?php if(strtotime("now") !=time()) {?><a href="javascript:">
        			<img src="<?php echo IMAGE_URL;?>/table_arrow_left.png" alt="arrow" id="doctorPre_<?php echo $test1;?>" onClick="PriviousCalenderOffice(this)" >
        			</a><?php } ?></div>            	
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
				$daylist1=	 $appointmentObj->appointmentShedualebydoctorId($test1,date('D',strtotime("now")),2);
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime("now"); ?>">
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            	...
            	<div class="cl-time">
            		<?php $availabilty=$appointmentObj->checkAvilableTime($test1,date('d-m-Y',strtotime("now")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
            					<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime("now"); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
				 	...
				 	<div class="cl-time down_00<?php echo $test1;?>11"><a title="Show More" onclick="return showDownOffice(this.id);" id="00<?php echo $test1;?>11"> More </a></div> <?php }?>
        	</div>
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist2=	 $appointmentObj->appointmentShedualebydoctorId($test1,date('D',strtotime( ' +1 day')),2);
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +1 day '); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
		<?php $availabilty=$appointmentObj->checkAvilableTime($test1,date('d-m-Y',strtotime("+1 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +1 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist3=	 $appointmentObj->appointmentShedualebydoctorId($test1,date('D',strtotime( ' +2 day')),2);
    ...
    <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +2 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
		<?php $availabilty=$appointmentObj->checkAvilableTime($test1,date('d-m-Y',strtotime("+2 day")),date("h:i a",$k));
			...
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +2 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist4=	 $appointmentObj->appointmentShedualebydoctorId($test1,date('D',strtotime( ' +3 day')),2);
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +3 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +3 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist5=	 $appointmentObj->appointmentShedualebydoctorId($test1,date('D',strtotime( ' +4 day')),2);
       ...
       <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
   		<?php $availabilty=$appointmentObj->checkAvilableTime($test1,date('d-m-Y',strtotime("+4 day")),date("h:i a",$k));
			...
			if(count($availabilty)==0) {?>
   			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +4 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a> <?php } else { echo "N/A"; }?></div>
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
   ...
   <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>
 			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +4 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a> <?php } else { echo "N/A"; }?></div>
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
        	...
        	<div class="cl-row-head"><strong><?php echo date('D',strtotime("+5 day"));?></strong><br><?php echo date('m-d-y',strtotime("+5 day"));?></div>
				...
				if($returndate !="")
				{
					$daylist6=	 $appointmentObj->appointmentShedualebydoctorId($test1,date('D',strtotime( ' +5 day')),2);
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +5 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a> <?php } else { echo "N/A"; } ?></div>
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>	
					...
					<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +5 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a> <?php }else { echo "N/A"; } ?></div>
  ...
  <?php if ($l+$x>5 && $returndate !="" && $daylist6[0] !="") { ?>
        	...
        	<div class="cl-row-head"><strong><?php echo date('D',strtotime("+6 day"));?></strong><br><?php echo date('m-d-y',strtotime("+6 day"));?></div>
				...
				if($returndate !="")
				{
					$daylist7=	 $appointmentObj->appointmentShedualebydoctorId($test1,date('D',strtotime( ' +6 day')),2);
     ...
     <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
 		<?php $availabilty=$appointmentObj->checkAvilableTime($test1,date('d-m-Y',strtotime("+6 day")),date("h:i a",$k));
			...
			if(count($availabilty)==0) {?>
 			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +6 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a><?php } else { echo "N/A"; }?></div>
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
 		<?php $availabilty=$appointmentObj->checkAvilableTime($test1,date('d-m-Y',strtotime("+6 day")),date("h:i a",$k));
			...
			if(count($availabilty)==0) {?>	
 			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +6 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a> <?php } else { echo "N/A"; }?></div>
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
        		<div class="cl-row-head <?php echo $test1;?>"><a href="javascript:"><img src="<?php echo IMAGE_URL;?>/table_arrow_right.png" alt="arrow" id="doctorNext_<?php echo $test1;?>" onClick="NextCalenderOffice(this)"></a></div>
