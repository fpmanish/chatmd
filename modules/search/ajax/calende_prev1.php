...
?>
	...
	<div class="cl-row-head <?php echo $id;?>" >
        			<a href="javascript:"><?php if($endDate >strtotime("now")){?>
        				<img src="<?php echo IMAGE_URL;?>/table_arrow_left.png" alt="arrow" id="doctorPre_<?php echo $id;?>" onClick="PriviousCalenderApp(this)" ><?php }?></a></div>        	
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
				$daylist1=	 $appointmentObj->appointmentShedualebydoctorId($id,date('D',strtotime($date1 ."-7 day")));
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist2=	 $appointmentObj->appointmentShedualebydoctorId($id,date('D',strtotime( $date1 ."-6 day")));
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist3=	 $appointmentObj->appointmentShedualebydoctorId($id,date('D',strtotime( $date1 ."-5 day")));
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist5=	 $appointmentObj->appointmentShedualebydoctorId($id,date('D',strtotime( $date1 ."-3 day")));
...
<?php echo date("h:i a",$k); ?> </a></div>
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
        	...
        	<div class="cl-row-head"><strong><?php echo date('D',strtotime($date1 ."-2 day"));?></strong><br><?php echo date('m-d-y',strtotime($date1 ."-2 day"));?></div>
				...
				if($returndate !="")
				{
					$daylist6=	 $appointmentObj->appointmentShedualebydoctorId($id,date('D',strtotime($date1 ."-2 day")));
...
<?php echo date("h:i a",$k); ?> </a></div>
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $n=$n+($AppointmentArr['intervalBetween']*60);
				 ...
				 ?>
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			<a title="Appointment Time" 	<?php if($_SESSION['AppTime']==$k && date("m-d-y",  $_SESSION['AppDate'])==date("m-d-y",  strtotime($date1 .' -2 day')))  { echo "class='time_active'"; }?>	 href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$id.genRandomPass(2)."&Time=".$k."&date=".strtotime($date1 ."-6 day"); ?>">
...
<?php echo date("h:i a",$k); ?> </a></div>
 ...
 <?php if ($l+$x>5 && $returndate !="" && $daylist6[0] !="") { ?>
        	...
        	<div class="cl-row-head"><strong><?php echo date('D',strtotime($date1 ."-1 day"));?></strong><br><?php echo date('m-d-y',strtotime($date1 ."-1 day"));?></div>
				...
				if($returndate !="")
				{
					$daylist7=	 $appointmentObj->appointmentShedualebydoctorId($id,date('D',strtotime( $date1 ."-1 day")));
