...
?>
	...
	<div class="cl-row-head <?php echo $id;?>" >
        			<a href="javascript:"><?php if($endDate >strtotime("now")){?>
        				<img src="<?php echo IMAGE_URL;?>/table_arrow_left.png" alt="arrow" id="doctorPre_<?php echo $id;?>" onClick="PriviousCalender(this)" ><?php }?></a></div>        	
