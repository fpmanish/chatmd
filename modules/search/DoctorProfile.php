...
include_once(MODULES_PATH."/search/code/profile_code.php");
      ...
      <?php 	}?></div>
		...
		if(count($specilityFindid)==$j+1){
		 ...
		 ?></span></strong></div>
            ...
            <div class="contact-info"> Tel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: +<?php echo $doctorDetails['phone'];?><br> Email  : <?php echo $rgistrationDeatlis['email']; ?>
            	<br> Location  : <?php $countryName= $blogObj->getCountryNameByCountryId($doctorDetails['CountryId']);
				 $stateName= $blogObj->getStateByStateId($doctorDetails['StateId']);
            	echo $countryName['countryName'].",". $stateName['regionName']; ?>
            </div>
        	<div class="do_blog"><?php $bogArr= $blogObj->getBlogBydoctorID($my_id); 
...
<?php  $timestring=$doctorDetails['about'];
          ...
          <div class="span12">
           ...
           <div class="span7" style="margin:auto" id="upload_<?php echo $my_id;?>" >
         	<?php 
      	...
      	<div class="calender" id="docTable_<?php echo $my_id;?>">
        	<div class="cl-row">
	<div class="cl-row-head <?php echo $my_id;?>" ><?php if(strtotime("now") !=time()) {?><a href="javascript:">
        			<img src="<?php echo IMAGE_URL;?>/table_arrow_left.png" alt="arrow" id="doctorPre_<?php echo $my_id;?>" onClick="PriviousCalender(this)" >
        			</a><?php } ?></div>            	
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
				$daylist1=	 $appointmentObj->appointmentShedualebydoctorId($my_id,date('D',strtotime("now")));
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("now")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$k."&date=".strtotime("now"); ?>">
 ...
 <div class="cl-time<?php if ($l+$x>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l+$x>5) {?> style="display:none"  <?php }?> >            		<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("now")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
            					<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$n."&date=".strtotime("now"); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
				 	...
				 	<div class="cl-time down_00<?php echo $my_id;?>11"   ><a title="Show More" onclick="return showDown(this.id);" id="00<?php echo $my_id;?>11"> More </a></div> <?php }?>
        	</div>
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist2=	 $appointmentObj->appointmentShedualebydoctorId($my_id,date('D',strtotime( ' +1 day')));
				if($AppointmentArr['intervalBetween'] >14 && $daylist2[0] !="" &&  $daylist2[3] !=""){
				 ...
				 ?>
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("+1 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
			
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +1 day '); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
		<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("+1 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +1 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist3=	 $appointmentObj->appointmentShedualebydoctorId($my_id,date('D',strtotime( ' +2 day')));
				if($AppointmentArr['intervalBetween'] >14 && $daylist3[0] !="" &&  $daylist3[3] !=""){
				 ...
				 ?>
    <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("+2 day")),date("h:i a",$k));
	
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +2 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
		<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("+2 day")),date("h:i a",$k));
			...
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +2 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist4=	 $appointmentObj->appointmentShedualebydoctorId($my_id,date('D',strtotime( ' +3 day')));
				if($AppointmentArr['intervalBetween'] >14  && $daylist4[0] !="" &&  $daylist4[3] !=""){
				 ...
				 ?>
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("+3 day")),date("h:i a",$k));
	
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +3 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +3 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            ...
            <div class="cl-row">
				...
				if($returndate !="")
				{
					$daylist5=	 $appointmentObj->appointmentShedualebydoctorId($my_id,date('D',strtotime( ' +4 day')));
				if($AppointmentArr['intervalBetween'] >14 && $daylist5[0] !="" &&  $daylist5[3] !=""){
				 ...
				 ?>
       <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
   		<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("+4 day")),date("h:i a",$k));
	
			if(count($availabilty)==0) {?>
   			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +4 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a> <?php } else { echo "N/A"; } ?></div>
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
   ...
   <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>
 			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +4 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a> <?php } else { echo "N/A"; }?></div>
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
        	...
        	<div class="cl-row-head"><strong><?php echo date('D',strtotime("+5 day"));?></strong><br><?php echo date('m-d-y',strtotime("+5 day"));?></div>
				...
				if($returndate !="")
				{
					$daylist6=	 $appointmentObj->appointmentShedualebydoctorId($my_id,date('D',strtotime( ' +5 day')));
				if($AppointmentArr['intervalBetween'] >14 && $daylist6[0] !="" &&  $daylist6[3] !=""){
				 ...
				 ?>
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("+5 day")),date("h:i a",$k));
	
			if(count($availabilty)==0) {?>
		
			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +5 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a> <?php }else { echo "N/A"; } ?></div>
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>	
					...
					<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +5 day'); ?>">
...
<?php if ($l>5 && $returndate !="" && $daylist6[0] !="") {?>
        	...
        	<div class="cl-row-head"><strong><?php echo date('D',strtotime("+6 day"));?></strong><br><?php echo date('m-d-y',strtotime("+6 day"));?></div>
				...
				if($returndate !="")
				{
					$daylist7=	 $appointmentObj->appointmentShedualebydoctorId($my_id,date('D',strtotime( ' +6 day')));
				 ...
				 ?>
     <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
 		<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("+6 day")),date("h:i a",$k));
	
			if(count($availabilty)==0) {?>
 			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +6 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a><?php }else { echo "N/A"; }?></div>
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $my_id;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
 		<?php $availabilty=$appointmentObj->checkAvilableTime($my_id,date('d-m-Y',strtotime("+6 day")),date("h:i a",$k));
			...
			if(count($availabilty)==0) {?>	
 			<a title="Appointment Time" href=" <?php echo MODULE_URL."/Appointment/DoctorProfile.php?test=".genRandomPass(3).$my_id.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +6 day'); ?>">
...
<?php echo date("h:i a",$k); ?> </a> <?php  } else { echo "N/A"; }?></div>
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
				 	...
				 	<div class="cl-time down_00<?php echo $my_id;?>11"><a> More </a></div> <?php }?>
        	</div>
            <div class="cl-row">
        		<div class="cl-row-head <?php echo $my_id;?>"><a href="javascript:"><img src="<?php echo IMAGE_URL;?>/table_arrow_right.png" alt="arrow" id="doctorNext_<?php echo $my_id;?>" onClick="NextCalender(this)"></a></div>
             	<div style="display:none" class="up_00<?php echo $my_id;?>11"><a title="Show Less" onclick="return showUp(this.id);" id="00<?php echo $my_id;?>11" ><img class="up_arrow" src="<?php echo IMAGE_URL;?>/table_arrow_up.png" alt="arrow"></a></div>
