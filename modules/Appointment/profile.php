...
<?php  $timestring=$doctorDetails['about'];
          ...
          <div class="span12">
           ...
           <?php if($error=="") { ?>
           	<input type="hidden" name="action" value="officeAppointment">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			<a title="Appointment Time "  <?php if($_SESSION['AppTime']==$k && date("m-d-y",  $_SESSION['AppDate'])==date("m-d-y",  strtotime('now')))  { echo "class='time_active'"; }?> href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime("now"); ?>">
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
            	...
            	<div class="cl-time">
            		<?php $availabilty=$appointmentObj->checkAvilableTime($test1,date('d-m-Y',strtotime("now")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
            					<a title="Appointment Time" <?php if($_SESSION['AppTime']==$k && date("m-d-y",  $_SESSION['AppDate'])==date("m-d-y",  strtotime('now')))  { echo "class='time_active'"; }?> href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime("now"); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			<a title="Appointment Time" <?php if($_SESSION['AppTime']==$k && date("m-d-y",  $_SESSION['AppDate'])==date("m-d-y",  strtotime(' +1 day')))  { echo "class='time_active'"; }?> href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +1 day '); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
		<?php $availabilty=$appointmentObj->checkAvilableTime($test1,date('d-m-Y',strtotime("+1 day")),date("h:i a",$k));
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" <?php if($_SESSION['AppTime']==$k && date("m-d-y",  $_SESSION['AppDate'])==date("m-d-y",  strtotime(' +1 day')))  { echo "class='time_active'"; }?> href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +1 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
    ...
    <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>
			<a title="Appointment Time"  <?php if($_SESSION['AppTime']==$k && date("m-d-y",  $_SESSION['AppDate'])==date("m-d-y",  strtotime(' +2 day')))  { echo "class='time_active'"; }?> href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +2 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
		<?php $availabilty=$appointmentObj->checkAvilableTime($test1,date('d-m-Y',strtotime("+2 day")),date("h:i a",$k));
			...
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" <?php if($_SESSION['AppTime']==$k && date("m-d-y",  $_SESSION['AppDate'])==date("m-d-y",  strtotime(' +2 day')))  { echo "class='time_active'"; }?> href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +2 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" <?php if($_SESSION['AppTime']==$k && date("m-d-y",  $_SESSION['AppDate'])==date("m-d-y",  strtotime(' +3 day')))  { echo "class='time_active'"; }?> href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +3 day'); ?>">
 ...
 <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
			...
			if(count($availabilty)==0) {?>
			<a title="Appointment Time" <?php if($_SESSION['AppTime']==$k && date("m-d-y",  $_SESSION['AppDate'])==date("m-d-y",  strtotime(' +3 day')))  { echo "class='time_active'"; }?> href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$n."&date=".strtotime(' +3 day'); ?>">
  ...
  $k=$k+($AppointmentArr['intervalBetween']*60);
       ...
       <div class="cl-time<?php if ($l>5) {?> showMore_00<?php echo $test1;?>11<?php }?>" <?php if ($l>5) {?> style="display:none"  <?php }?> >
   		<?php $availabilty=$appointmentObj->checkAvilableTime($test1,date('d-m-Y',strtotime("+4 day")),date("h:i a",$k));
			...
			if(count($availabilty)==0) {?>
   			<a title="Appointment Time" <?php if($_SESSION['AppTime']==$k && date("m-d-y",  $_SESSION['AppDate'])==date("m-d-y",  strtotime(' +4 day')))  { echo "class='time_active'"; }?> href=" <?php echo MODULE_URL."/Appointment/profile.php?test=".genRandomPass(3).$test1.genRandomPass(2)."&Time=".$k."&date=".strtotime(' +4 day'); ?>">
