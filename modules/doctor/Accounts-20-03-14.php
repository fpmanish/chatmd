  ...
  <div class="row">
    ...
    <div class="span12 past-app top_do_bg_contant_box">
      <div class="bs-docs-example">
          ...
          <?php 
            $pagination = new pagination($patientData, (isset($_GET['page']) ? $_GET['page'] : 1), 15);
          ...
          <tr class="top_doctor">
            ...
            <td class="top_doctor" width="20%"><strong><?php echo $patientData[$i]['display_time']; ?></strong></td>
                <td class="top_doctor" width="20%"><strong><?php if($patientData[$i]['display_date']==date('d-m-Y')) { ?><a style="color:white" href="<?php echo MODULE_URL."/chatMD_vid/chatStart.php?doctor=".$_SESSION['AD_admin_user_id'].
                "&accessKey=".$patientData[$i]['access_token']; ?>" class="pa-info-but">Chat</a>
                       	<?php }?></strong></td>
          </tr>
         
          <?php }?>
              <tr> <td></td><td></td><td></td><td> <?php  echo $pageNumbers = '<div class="numbers">'.$pagination->getLinks().'</div>';?></td></tr>
        </table>
            </div>
              </div>
          ...
          <?php 
            $pagination = new pagination($doctorAsPatientData, (isset($_GET['page']) ? $_GET['page'] : 1), 15);
         ...
         "&accessKey=".$doctorAsPatientData[$j]['access_token']; ?>" class="pa-info-but">Chat</a>
                       	<?php }?></strong></td>
          </tr>
