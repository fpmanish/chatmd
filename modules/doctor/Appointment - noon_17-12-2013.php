...
return dat.getMonth();
 ...
 if((day)>=(<?php echo $startDay; ?>) || (<?php echo $endDay; ?>)>=(day) 
 && (IntMonth) >=<?php echo $startMonth ;?>  || (IntMonth)>=<?php echo $endMonth ;?>
 && (NumWeek) >=<?php echo $startWeek ;?>  && (NumWeek)>=<?php echo $endWeek ;?>
 ){
