...
public function __construct($config=""){
  ...
  //default settings
  $settings = array(
  'business' => 'satyanarayan-facilitator@futureprofilez.com',         //paypal email address
  'currency' => 'USD',                       //paypal currency
  'cursymbol'=> '$',                   //currency symbol
  'location' => 'GB',                        //location code  (ex GB)
  'returnurl'=> 'http://chat-md.com/modules/sign_up/',//where to go back when the transaction is done.
  ...
  $this->items = array();
    ...
    public function getCheckoutForm(){
        ...
        $form='
        <form id="paypal_checkout" action="https://www.sandbox.paypal.com/cgi-bin/webscr?
cmd=_express-checkout" method="post">';
